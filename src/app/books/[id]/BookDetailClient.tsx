        ...
        <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 pt-32 pb-32 lg:pb-20 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="flex justify-between items-center mb-12">
                    ...
                    <button 
                        onClick={handleShare}
                        className="p-3 rounded-2xl bg-white dark:bg-emerald-900/20 border border-emerald-500/10 text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-900/40 transition-all active-scale shadow-sm"
                        title="Partager"
                    >
                        <Share2 size={20} />
                    </button>
