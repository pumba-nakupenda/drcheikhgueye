...
export default function BooksPage() {
    return (
        <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 py-20 md:py-32 relative overflow-hidden">
            <div className="absolute top-0 left-0 w-1/3 h-1/3 bg-emerald-500/5 blur-[120px] rounded-full" />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
                    ...
                    <h1 className="text-5xl md:text-6xl font-serif font-black text-emerald-950 dark:text-white leading-tight">
                        La <span className="text-emerald-600">Bibliothèque.</span>
                    </h1>
                    <p className="text-lg text-emerald-900/60 dark:text-emerald-100/60 font-light leading-relaxed">
                        Parcourez la collection complète des œuvres du Dr. Cheikh Gueye. Des méthodes pédagogiques innovantes pour l'apprentissage de la langue arabe.
                    </p>
                </div>
